...
description: Audits code for exploitable vulnerabilities — injection, authn/authz gaps, IDOR, secret exposure, SSRF, insecure headers, and LLM-specific risks — and verifies each finding is reachable before reporting it. Use when the user asks for a security-focused review, threat model, or hardening pass on specific code.
