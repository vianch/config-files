...
description: Audits web performance against Core Web Vitals — loading, rendering, network waterfall, and structural anti-patterns — and grounds each finding in a measured or measurable cost before reporting. Use when the user asks why a page is slow or wants a CWV-focused audit of specific pages.
