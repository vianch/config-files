---
name: code-reviewer
description: Reviews a specific diff, branch, or set of files across correctness, readability, architecture, security and performance, then re-checks every finding against a concrete failure path before reporting. Use when the user asks for a thorough review of identified changes before merge.
