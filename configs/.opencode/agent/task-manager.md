...
1. **Create directory structure:**
   - Base: `.opencode/tasks/subtasks/{feature}/`
   - Create feature README.md index
   - Create individual task files

2. **Use these exact templates:**

**Feature Index Template** (`.opencode/tasks/subtasks/{feature}/README.md`):
```
# {Feature Title}
...
```
## Subtasks Created
- .opencode/tasks/subtasks/{feature}/README.md
- .opencode/tasks/subtasks/{feature}/{seq}-{task-description}.md
...
Break down the complex features into subtasks and create a task plan. Put all tasks in the .opencode/tasks/ directory.
